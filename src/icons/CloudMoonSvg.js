...
const CloudMoonSvg = forwardRef(({ color = 'currentColor', size = 24, ...rest }, ref) => {
  return (
    <svg
      ref={ref}
...
CloudMoonSvg.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};

CloudMoonSvg.displayName = 'CloudMoonSvg';

export default CloudMoonSvg;
